...
class RBT():
    ...
    def check(self):
        ...
        while stack:
            ...
            if x.left != None:
                print(x.left.color)
                print(self.root.right.left.color)
    ...
    def delete(self, x):
        ...
        if x.left == None and x.right == None:
            ...
            p = x.par
            # 削除するノードが黒の場合は, xとpの間のエッジを削除して終了
            if x.color:
                if p.left == x:
                    p.left = None
                else:
...
if __name__ == '__main__':
    ...
    print(r.key, r.color)
    print(r.left.key, r.left.color)
    print(r.right.key, r.right.color)
    print(r.right.left.key, r.right.left.color)
    ...
    print(r.left.key, r.left.color)
    print(r.right.key, r.right.color)
    print(r.left.right.key, r.left.right.color)
